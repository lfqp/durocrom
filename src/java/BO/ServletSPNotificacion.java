 ...
 * @author User
 */
@WebServlet(name = "ServletSPNotificacion", urlPatterns = {"/ServletSPNotificacion"})
public class ServletSPNotificacion extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            String opcion_Notificaciones = request.getParameter("opcion_Notificaciones");
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(ServletSPNotificacion.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
